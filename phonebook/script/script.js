import {getStorage,
  removeStorage,
  setStorage} from './module/storageActions.js';
...

{
  ...
  const renderPhoneBook = (app, title) => {
    ...
    const footerCopyright = createCopyright(title);
  ...
  const init = (selectorApp, title) => {
    ...
    // функционал
    const allRow = renderContact(list, getStorage('phone'));
